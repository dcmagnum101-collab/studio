      ...
      <div className="flex min-h-screen w-full">
        ...
        <SidebarInset>
          ...
          <main className="p-4 md:p-8 max-w-5xl mx-auto w-full space-y-6 md:space-y-8 pb-24">
            {!isLoading && (!tasks || tasks.length === 0) && activeTab === 'pending' ? (
              <div className="flex flex-col items-center justify-center py-24 sm:py-32 space-y-8 animate-in fade-in zoom-in-95 duration-500">
                ...
                <div className="text-center space-y-3">
                  <h2 className="text-2xl font-black text-primary">No tasks yet</h2>
                  <p className="text-slate-500 max-w-sm mx-auto text-sm">
                    Tasks are auto-created when you import leads and start follow-up sequences. Import your first leads to get started.
                  </p>
                </div>
                <Button asChild size="lg" className="bg-primary h-14 px-10 rounded-2xl font-black shadow-xl shadow-primary/10 gap-2">
                  <Link href="/contacts">
                    Go to Prospector <ArrowRight className="h-5 w-5" />
                  </Link>
                </Button>
              </div>
            ) : (
