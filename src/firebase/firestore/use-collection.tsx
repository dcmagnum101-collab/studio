          ...
          if (options.realtime) {
                  const unsubscribe = onSnapshot(
                            ...
                            async (serverError: any) => {
                                        // Silently ignore permission-denied and not-found —
                                        // collection may not exist yet on first load. This is expected.
                                        if (
...
}interface UseCollectionOptions {  realtime?: boolean;
}
